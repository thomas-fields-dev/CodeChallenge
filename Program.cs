                ...
                switch (menuSelection)
                {
                    case 1:
                        for (int i = 0; i < maxPets; i++)
                        {
                            ...
                            int idPosition = currentPetId.LastIndexOf(" ");
                            string currentId = currentPetId.Substring(idPosition).Trim();
                            if (currentId != "")
                            {
                                //Console.WriteLine($"Existing pet data found for {ourAnimals[i, 0]}");
                                for (int j = 0; j < 5; j++)
                                {
                    ...
                    case 2:
                        ...
                        while (anotherPet == "y")
                        {
                            ...
                            if (petsWithData < maxPets)
                            {
                                ...
                                ourAnimals[petsWithData, 0] = "ID #: " + Console.ReadLine();
                                Console.WriteLine("Enter Animal Species:");
                                ourAnimals[petsWithData, 1] = "Species: " + Console.ReadLine();
                                Console.WriteLine("Enter Animal Age:");
                                ourAnimals[petsWithData, 2] = "Age: " + Console.ReadLine();
                                Console.WriteLine("Enter Animal Nickname:");
                                ourAnimals[petsWithData, 3] = "Nickname: " + Console.ReadLine();
                                Console.WriteLine("Enter Animal Physical Description:");
                                ourAnimals[petsWithData, 4] = "Physical description: " + Console.ReadLine();
                            ...
                            anotherPet = anotherPet?.ToLower().Trim();
                        }
                        break;
                    case 3:
                        break;
